...
assert.equal(result[0].hasAttachments, false);
const withAttachment = row(7, '2026-09-11').replace('</tr>', '<td><a href="javascript:file_down(7,1)">pdf파일</a></td></tr>');
assert.equal(parseSupportNotices(withAttachment)[0].hasAttachments, true);
