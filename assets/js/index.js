...
function openStructureSample(event){
  ...
  const popup = window.open(
    'structure_review_sample_view.html',
    'structureSample',
    `popup=yes,width=${width},height=${height},left=${left},top=${top},resizable=yes,scrollbars=yes`
  );

  if(!popup){
    window.location.href = 'structure_review_sample_view.html';
  }
  return false;
}
...
function openFieldInspectionSample(event){
  ...
  const popup = window.open(
    'field_inspection_sample_view.html',
    'fieldInspectionSample',
    `popup=yes,width=${width},height=${height},left=${left},top=${top},resizable=yes,scrollbars=yes`
  );

  if(!popup){
    window.location.href = 'field_inspection_sample_view.html';
  }
  return false;
}
